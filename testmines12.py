...
#screen (pygame display) - the screen for the game
...
#screen (pygame display) - screen to move the map on
...
#tilemap (TileMap) - tilemap to place the mmine on
#pos (tuple) - the position to place it at
def placeWin(tilemap,pos):
    tilemap.getTile(pos).change(mines[MINE_WIN],tileset[MINE_WIN])
...
#screen (pygame display) - the game screen to draw to
def menu(screen):
